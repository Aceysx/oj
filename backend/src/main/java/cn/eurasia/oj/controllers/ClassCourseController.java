...
import cn.eurasia.oj.controllers.request.EditClassCourseRequest;
...
public class ClassCourseController {
    ...
    @PutMapping("")
    public ResponseEntity editClassCourse(@RequestBody EditClassCourseRequest request) throws BusinessException {
        classCourseService.editClassCourse(request.getClassCourse(), request.getClassCoursePapers());
    ...
    @GetMapping("{classCourseId}/papers/{paperId}")
    public ResponseEntity getPaperByClassCourseId(
        @PathVariable Long classCourseId,
        @PathVariable Long paperId
    ) throws BusinessException {
        return ResponseEntity.ok(classCourseService.getClassCoursePaperBy(classCourseId, paperId));
    }
